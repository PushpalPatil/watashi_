                    ...
                    <div className="flex-1 flex flex-col items-center justify-center px-4">
                        <div className="text-center space-y-4 mb-8">
                            ...
                            <h1 className="text-4xl font-normal bg-gradient-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent">
                                let&apos;s yap {mercurySign.toLowerCase()}
                            </h1>
                            <p className="text-lg text-muted-foreground max-w-md">
                                as your Mercury sign, I&apos;m here to help you communicate clearly, process information effectively, and express your thoughts with wit and intelligence.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-2xl mb-8 font-normal">
                            {[
                                "Tell me about my public speaking tendencies",
                                "How can I express myself better?",
                                "What is my communication style?",
                                "Help me build a game plan towards excellent public speaking"
                            ].map((prompt) => (
                                <button
                                    key={prompt}
                    ...
                    <div className="max-w-4xl mx-auto p-4">
                        <form onSubmit={handleSubmit} className="relative">
                            <Textarea
                                ...
                                placeholder={`Ask your Mercury agent anything about your ${mercurySign} energy...`}
