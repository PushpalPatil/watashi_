          ...
          >
            ...
            <div className="space-y-3">
              {ONBOARDING_QUESTIONS.map((question) => (
                ...
                >
                  <div className="text-white/90 text-sm leading-relaxed group-hover:text-white">
                    {question.text}
                  </div>
                  <div className="text-white/40 text-xs mt-2 group-hover:text-white/60">
                    {question.category}
                  </div>
                </button>
              ))}
            ...
            <div className="mt-6 text-center">
              <button
                onClick={onClose}
                className="text-white/50 hover:text-white/70 active:text-white/80 text-xs transition-colors py-2 px-4 rounded touch-manipulation"
              >
